...
"""Archived DE routing-parameter search script.

This module is retained only for reproducing historical `risk-router-de`
artifacts. DE is not used by the RAIR-RAG main experiments or paper claims.
Use `scripts/run_rair_eval.sh` for the RAIR-RAG routing evaluation.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Reproduce archived risk-router-de parameter search with Differential Evolution."
    )
