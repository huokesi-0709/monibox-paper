...
def add_vits_args(parser):
    parser.add_argument(
        "--vits-model", type=str, default="", help="Path to vits model.onnx"
    )

    parser.add_argument(
        "--vits-lexicon", type=str, default="", help="Path to lexicon.txt"
    )

    parser.add_argument(
        "--vits-tokens", type=str, default="", help="Path to tokens.txt"
    )
...
def add_matcha_args(parser):
    ...
    parser.add_argument(
        "--matcha-vocoder", type=str, default="", help="Path to vocoder for matcha"
    )

    parser.add_argument(
        "--matcha-lexicon", type=str, default="", help="Path to lexicon.txt for matcha"
    )

    parser.add_argument(
        "--matcha-tokens", type=str, default="", help="Path to tokens.txt for matcha"
    )
...
def add_kokoro_args(parser):
    parser.add_argument(
        "--kokoro-model", type=str, default="", help="Path to model.onnx for kokoro"
    )

    parser.add_argument(
        "--kokoro-voices", type=str, default="", help="Path to voices.bin for kokoro"
    )

    parser.add_argument(
        "--kokoro-tokens", type=str, default="", help="Path to tokens.txt for kokoro"
    )
...
def add_kitten_args(parser):
    parser.add_argument(
        "--kitten-model", type=str, default="", help="Path to model.onnx for kitten"
    )

    parser.add_argument(
        "--kitten-voices", type=str, default="", help="Path to voices.bin for kitten"
    )

    parser.add_argument(
        "--kitten-tokens", type=str, default="", help="Path to tokens.txt for kitten"
    )
...
def get_args():
    ...
    parser.add_argument(
        "--tts-rule-fsts", type=str, default="", help="Path to rule.fst"
    )
    ...
    parser.add_argument(
        "--debug", type=bool, default=False, help="True to show debug messages"
    )

    parser.add_argument(
        "--provider", type=str, default="cpu", help="valid values: cpu, cuda, coreml"
    )
    ...
    parser.add_argument("text", type=str, help="The input text to generate audio for")
